# Kwik Eat food delivery app
This is your friendly guide to all the API endpoints needed for your **Kwik Eat food delivery app**.
 I've listed them out with what they do, the request and response formats, and where in the code you'll need to use them. Remember, these are the backend endpoints your Node.js/Express server should have.
